...
-- -----------------------------------------------------
-- Table `restaurant_review`.`PRODUCT`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `restaurant_review`.`PRODUCT` (
  ...
  `picture` VARCHAR(1000) NULL DEFAULT NULL, -- This is the new column for image URLs
  PRIMARY KEY (`id`))
ENGINE = InnoDB
AUTO_INCREMENT = 1
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `restaurant_review`.`review` (
  ...
  CONSTRAINT `review_restuarant_id`
    ...
    REFERENCES `restaurant_review`.`PRODUCT` (`id`)
    ON DELETE CASCADE)
ENGINE = InnoDB
AUTO_INCREMENT = 1
DEFAULT CHARACTER SET = utf8mb4
...
-- INSERT INTO `restaurant_review`.`PRODUCT`
-- (`name`, `address`, `description`, `rating`, `cuisine_type`, `opening_date`, `picture`) VALUES
